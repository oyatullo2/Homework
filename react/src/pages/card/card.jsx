...
export const Card = () => {
  ...
  return (
    <>
      <div
        className="w-full flex-col h-[92vh] flex items-center justify-center"
      ...
      >
        <div className="border-2 border-[#704A24] w-[600px] h-[300px] rounded-xl bg-white shadow-[0px_0px_10px_3px_rgb(0,0,0,0.3)]">
          <div className="flex flex-col">
            <div className="flex flex-col w-full max-w-[500px] mx-auto gap-[10px] mt-[40px]">
              <p>
                Card number :{" "}
                {cardNumber.length ? cardNumber : "0123 4567 8901 2345"}
              </p>
            ...
            <div className="flex flex-col h-[20.2vh] w-full max-w-[500px] mx-auto gap-[10px] items-end justify-end">
              <input
                ...
                className="w-full py-[7px] pl-[10px] rounded-md border-2 border-[#704A24]"
        ...
        <button
          onClick={handReset}
          className="mt-[50px] bg-[#FBA651] text-white py-[8px] w-full max-w-[300px] rounded-[10px] font-[500] text-[20px] flex items-center justify-center gap-[10px]"
        >
          Pay <i className="fa-brands fa-cc-visa"></i>
        </button>
      </div>
      <div
        className="w-full h-[92vh] items-center justify-center flex"
        style={{ display: loading ? "flex" : "none" }}
      >
        <p className="text-[40px] font-[600] text-green-500">
